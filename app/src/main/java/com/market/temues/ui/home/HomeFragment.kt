...
class HomeFragment : Fragment() {
                ...
                viewModel.uiState.collect { state ->
                    when (state) {
                        ...
                        is ProductListUiState.Success -> {
                            ocultarCargando()
                            renderProducts(state.products, getString(R.string.products_empty))
                        }
    ...
    private fun mostrarCargando() {
        ...
        binding.txtProductsStatus.text = getString(R.string.products_loading)
    }
    ...
    private fun renderProducts(products: List<Product>, emptyMessage: String) {
        binding.txtProductsStatus.text = if (products.isEmpty()) {
            emptyMessage
        } else {
            getString(R.string.products_loaded, products.size)
        }
